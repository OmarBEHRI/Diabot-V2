...
export default function BenchmarksPage() {
  ...
  // Data for multiple choice benchmark results from JSON file
  const multipleChoiceResults: ModelResult[] = [
    { model: "anthropic/claude-3.7-sonnet", timestamp: "2025-05-29", accuracy: 100.0, total_questions: 157, correct_answers: 157, processing_time_seconds: 412.56 },
    { model: "deepseek/deepseek-chat-v3-0324", timestamp: "2025-05-29", accuracy: 98.73, total_questions: 157, correct_answers: 155, processing_time_seconds: 305.32 },
    { model: "google/gemini-2.5-flash-preview-05-20", timestamp: "2025-05-29", accuracy: 100.0, total_questions: 157, correct_answers: 157, processing_time_seconds: 287.32 },
    { model: "google/gemma-3-4b-it", timestamp: "2025-05-29", accuracy: 96.18, total_questions: 157, correct_answers: 151, processing_time_seconds: 215.67 },
    { model: "meta-llama/llama-3.1-8b-instruct-fine-tuned", timestamp: "2025-05-29", accuracy: 73.25, total_questions: 157, correct_answers: 115, processing_time_seconds: 165.23 },
    ...
    { model: "meta-llama/llama-4-scout", timestamp: "2025-05-29", accuracy: 98.73, total_questions: 157, correct_answers: 155, processing_time_seconds: 362.18 },
    { model: "mistralai/mistral-nemo", timestamp: "2025-05-29", accuracy: 99.36, total_questions: 157, correct_answers: 156, processing_time_seconds: 298.45 },
    { model: "openai/gpt-4.1-mini", timestamp: "2025-05-29", accuracy: 100.0, total_questions: 157, correct_answers: 157, processing_time_seconds: 325.18 },
  ];
  
  // Data for free-form benchmark results from JSON file
  const freeFormResults: ModelResult[] = [
    { model: "Llama-3.1-8b-instruct-fine-tuned", timestamp: "2025-05-29", accuracy: 66.88, total_questions: 157, correct_answers: 105 },
    { model: "qwen/qwen-2.5-7b-instruct", timestamp: "2025-05-29", accuracy: 64.33, total_questions: 157, correct_answers: 101 },
    ...
    { model: "meta-llama/llama-4-scout", timestamp: "2025-05-29", accuracy: 84.71, total_questions: 157, correct_answers: 133 },
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="multiple-choice" className="mt-4">
                <Card>
                  ...
                  <CardContent>
                    <Table>
                      <TableCaption>Multiple Choice Benchmark Results - sorted by accuracy (highest first)</TableCaption>
                      <TableHeader>
                        <TableRow>
                            ...
                            <TableRow key={index} className={index === 0 ? "bg-emerald-50" : ""}>
                              <TableCell className="font-medium">
                                <div className="flex flex-col">
                                  <span>{result.model.includes('/') ? result.model.split('/')[1] : result.model}</span>
                                  <span className="text-xs text-gray-500">{result.model.includes('/') ? result.model.split('/')[0] : ''}</span>
                                </div>
                              </TableCell>
                              <TableCell>
                                <Badge className={
              ...
              <TabsContent value="free-form" className="mt-4">
                <Card>
                  ...
                  <CardContent>
                    <Table>
                      <TableCaption>Free-Form Answer Benchmark Results - sorted by accuracy (highest first)</TableCaption>
                      <TableHeader>
                        <TableRow>
                          <TableHead>Model</TableHead>
                          <TableHead>Accuracy</TableHead>
